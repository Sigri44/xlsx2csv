<?php
  ...
  if (isset($_POST["convert"])) {
    ...
    if($filetoname==""){
      ...
      if($ext!="xlsx"){
        $alert = "Invalid file type. Select an .xlsx file.";
      } else {
    ...
    <head>
      ...
      <style type="text/css">
        ...
        */      
        ...
        function init(){
          setTimeout("document.getElementById(\'msg\').innerHTML=\'\'",5500);
          CreateTimer("timer",5);
        };   
        window.onload=init; 
      </script> 
    ...
    <body>
      <div id="container">
        ...
        <form action="#" method="post" enctype="multipart/form-data">
          ...
          <br />
          <input type="text" name="throttle" id="throttle" value="0" onkeyup="this.value=this.value.replace(/[^\d]/,\'\')" size="5"> # of rows to convert (0 = no limit)
          <br />
